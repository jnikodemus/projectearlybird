    ...
    companion object {
        ...
        const val SQL_CREATE_ENTRIES =
            "CREATE TABLE " + UserEntry.TABLE_NAME + " (" +
                    UserEntry._ID + SQL_INTEGER_TYPE + SQL_PRIMARY_KEY_AUTOINCREMENT + SQL_COMMA_SEP +
                    ...
                    UserEntry.COLUMN_USER_GENDER + SQL_INTEGER_TYPE + SQL_NOT_NULL + " DEFAULT 2" + SQL_COMMA_SEP +
                    UserEntry.COLUMN_USER_AVATAR + SQL_BLOB_TYPE + SQL_COMMA_SEP +
                    UserEntry.COLUMN_USER_PARSE_USER + SQL_TEXT_TYPE + SQL_COMMA_SEP +
                    UserEntry.COLUMN_USER_CREATED_AT + SQL_INTEGER_TYPE + SQL_NOT_NULL + SQL_COMMA_SEP +
                    UserEntry.COLUMN_USER_LASTLOGIN + SQL_INTEGER_TYPE +
                    ")"
